//
// Clustered dot dither matrix for LPrint, a Label Printer Utility
//
...
#ifndef _CLUSTERED_H_
#  define _CLUSTERED_H_

const unsigned char clustered[16][16] =// Clustered-Dot Dither Matrix
{
