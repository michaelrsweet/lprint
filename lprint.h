...
extern int		lprintDoAdd(int argc, char *argv[]);
extern int		lprintDoCancel(int argc, char *argv[]);
extern int		lprintDoDefault(int argc, char *argv[]);
extern int		lprintDoDelete(int argc, char *argv[]);
extern int		lprintDoDevices(int argc, char *argv[]);
extern int		lprintDoDrivers(int argc, char *argv[]);
extern int		lprintDoJobs(int argc, char *argv[]);
extern int		lprintDoModify(int argc, char *argv[]);
